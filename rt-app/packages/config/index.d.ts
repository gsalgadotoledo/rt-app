...
export function runtimeConfig(settings: {runtime:Record<string,{mode:string}>},env?:Record<string,string|undefined>):{target:'local'|'aws';mode:'json'|'memory'|'dynamodb-local'|'aws'};
