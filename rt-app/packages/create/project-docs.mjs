...
npm exec -- rta urls`: '# AWS deployment is not available for this backend yet.';
 return `# ${name}\n${templateName} · ${backendId}. Requires Node 22.14+ and Rust/Cargo for the local CLI${backendId==='python'?', Python 3.11+':backendId==='go'?', Go 1.22+':backendId==='java'?', JDK 21+':''}; AWS setup also requires Terraform.\n\n\`\`\`sh\n# Install\nnpm install\n# Local — no AWS credentials needed\nnpm run dev\n${cloud}\n\`\`\`\n`;
}
